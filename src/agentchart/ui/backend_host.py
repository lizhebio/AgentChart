...
from agentchart.api.client import SupportsStreamingMessages
from agentchart.auth.manager import AuthManager
from agentchart.config.settings import CLAUDE_MODEL_ALIAS_OPTIONS, display_model_setting
from agentchart.bridge import get_bridge_manager
from agentchart.themes import list_themes
...
from agentchart.ui.protocol import BackendEvent, FrontendRequest, TranscriptItem
from agentchart.ui.runtime import build_runtime, close_runtime, handle_line, start_runtime
...
class ReactBackendHost:
    """Drive the AgentChart runtime over a structured stdin/stdout protocol."""
