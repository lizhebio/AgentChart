"""Path resolution for AgentChart configuration and data directories.

Follows XDG-like conventions with ~/.agentchart/ as the default base directory.
"""
...
def get_config_file_path() -> Path:
    """Return the path to the main settings file (~/.agentchart/settings.json)."""
...
def get_project_config_dir(cwd: str | Path) -> Path:
    """Return the per-project .agentchart directory."""
    project_dir = Path(cwd).resolve() / ".agentchart"
