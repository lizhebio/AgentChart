...
from agentchart.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
...
from agentchart.hooks.schemas import (
    AgentHookDefinition,
...
from agentchart.hooks.types import AggregatedHookResult, HookResult
from agentchart.sandbox import SandboxUnavailableError
...
class HookExecutor:
    ...
    async def _run_command_hook(
        ...
        try:
            process = await create_shell_subprocess(
                ...
                env={
                    **os.environ,
                    "AGENTCHART_HOOK_EVENT": event.value,
                    "AGENTCHART_HOOK_PAYLOAD": json.dumps(payload),
                },
            )
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in AgentChart. "
