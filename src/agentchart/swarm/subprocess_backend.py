...
from agentchart.swarm.spawn_utils import (
...
class SubprocessBackend:
    ...
    Uses the existing :class:`~agentchart.tasks.manager.BackgroundTaskManager`
    ...
    async def spawn(self, config: TeammateSpawnConfig) -> SpawnResult:
        ...
        cmd_parts = [teammate_cmd, "-m", "agentchart"] + flags
