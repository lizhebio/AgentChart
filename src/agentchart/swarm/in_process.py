...
* :class:`InProcessBackend` – implements
  :class:`~agentchart.swarm.types.TeammateExecutor` and manages the dict of
  live asyncio Tasks.
"""
...
async def start_in_process_teammate(
    *,
    ...
    2. Drives the query engine loop (reusing
       :func:`~agentchart.engine.query.run_query`).
    ...
    query_context:
        Optional pre-built
        :class:`~agentchart.engine.query.QueryContext`.  When *None* this
...
async def _run_query_loop(
    ...
    """Drive :func:`~agentchart.engine.query.run_query` until done or cancelled.
    ...
    from agentchart.engine.query import run_query
...
class InProcessBackend:
    ...
    async def send_message(self, agent_id: str, message: TeammateMessage) -> None:
        ...
        from agentchart.swarm.mailbox import MailboxMessage
