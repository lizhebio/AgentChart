"""Permission sync protocol for leader-worker coordination in AgentChart swarms.
...
Paths:
    ~/.agentchart/teams/<teamName>/permissions/pending/<id>.json
    ~/.agentchart/teams/<teamName>/permissions/resolved/<id>.json
"""
...
from agentchart.swarm.lockfile import exclusive_file_lock
from agentchart.swarm.mailbox import (
    MailboxMessage,
    TeammateMailbox,
...
def get_permission_dir(team_name: str) -> Path:
    """Return ~/.agentchart/teams/{teamName}/permissions/"""
...
async def get_leader_name(team_name: str | None = None) -> str | None:
    ...
    """
    from agentchart.swarm.team_lifecycle import read_team_file_async
...
async def handle_permission_request(
    ...
    Args:
        ...
        checker: An already-configured :class:`~agentchart.permissions.checker.PermissionChecker`.
