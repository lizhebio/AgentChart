"""Agent definition loading system for AgentChart."""
...
def get_all_agent_definitions() -> list[AgentDefinition]:
    ...
    1. Built-in agents
    2. User agents (~/.agentchart/agents/)
    ...
    try:
        from agentchart.plugins.loader import load_plugins  # noqa: PLC0415
        from agentchart.config.settings import load_settings  # noqa: PLC0415
