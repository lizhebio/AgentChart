"""Unified authentication manager for AgentChart providers."""
...
# Providers that AgentChart knows about.
_KNOWN_PROVIDERS = [
    "anthropic",
    "anthropic_claude",
    "openai",
...
class AuthManager:
    ...
    Reads/writes credentials via :mod:`agentchart.auth.storage` and keeps
    ...
    def save_settings(self) -> None:
        ...
        from agentchart.config import save_settings
