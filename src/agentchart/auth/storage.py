"""Secure credential storage for AgentChart.

Default backend: ~/.agentchart/credentials.json with mode 600.
...
def _obfuscation_key() -> bytes:
    ...
    seed = str(Path.home()).encode() + b"agentchart-v1"
