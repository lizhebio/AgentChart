...
Runs as a standalone process (``ac cron start``) or can be embedded via
...
from agentchart.config.paths import get_data_dir, get_logs_dir
from agentchart.services.cron import (
    load_cron_jobs,
    mark_job_run,
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``ac cron start``)
# ---------------------------------------------------------------------------
