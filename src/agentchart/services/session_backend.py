...
from agentchart.services import session_storage
...
class AgentChartSessionBackend:
    """Default session backend backed by ``~/.agentchart/data/sessions``."""
...
DEFAULT_SESSION_BACKEND: SessionBackend = AgentChartSessionBackend()
